...
export default function AboutPgStocks() {
        ...
        <h1 className="text-center mb-5 developers">Developers👩‍💻</h1>
          ...
          <div className="container">
            <div className="row mt-3">
              <div className="col-4">
                <div className="card border border-dark p-2" style={{borderRadius:"5%"}}>
                CoinFlix is a stock market tracker app that lets you monitor all of your stocks in one place. We cover all the major exchanges in India.It also gives users insights into the performance of companies. 
                </div>
              </div>
              <div className="col-4">
                <div className="card border border-dark p-2" style={{borderRadius:"5%"}}>
                CoinFlix is a free online stock market tracker that makes it easy to keep track of stocks, shares, and the latest financial events.
                Users can also use this as a list of stocks to buy, sell, or short-sell.
                </div>
              </div>
              <div className="col-4">
                <div className="card border border-dark p-2" style={{borderRadius:"5%"}}>
                Track your stocks live with CoinFlix. Get notified when things happen in the stock market. If you want to invest with the knowledge of what's happening around you, CoinFlix is the app for you.
                </div>
              </div>
            </div>
          </div>
